...
void showTitle() {
    ...
    cout << left << setw(44) << "\033[31mの\033[0m 音响位置"        << "   │        ↓ \n"          ; // 红色
    cout << left << setw(44) << "\033[35mの\033[0m 音量 100dB以上"  << "   │ 180° ← · → 0°(360°)\n" ; // 紫色
    cout << left << setw(42) << "\033[34mの\033[0m 音量 85 ~ 100dB" << "   │       90°\n"          ; // 蓝色
    cout << left << setw(42) << "\033[33mの\033[0m 音量 70 ~ 85dB"  << "   │        ↑ \n"          ; // 黄色
    cout << left << setw(38) << "\033[37mの\033[0m 低于70dB"        << " y ↓       270°\n"         ; // 白色
    cout << "==============================================================" << "\n";
}
